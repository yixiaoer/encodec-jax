...
def foward_encodec(params: EncodecModelParams, input_: Array, padding_mask: Array) -> Array:
...
def test_methods_encodec(model: EncodecModel) -> None:
    ...
    out_forward = foward_encodec(encodec_params, inputs['input_values'], inputs['padding_mask'], )
